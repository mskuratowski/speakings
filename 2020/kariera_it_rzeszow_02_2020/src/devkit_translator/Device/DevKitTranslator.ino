...
static const char *allLanguages[LANGUAGES_COUNT] = {"Arabic", "Chinese", "French", "German", "Italian", "Japanese", "Polish", "Portuguese", "Russian", "Spanish"};
static const char *allLocalNames[LANGUAGES_COUNT] = {"ar-EG", "zh-CN", "fr-FR", "de-DE", "it-IT", "ja-JP", "pl-PL", "pt-BR", "ru-RU", "es-ES"};
